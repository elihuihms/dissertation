...
protocol.addUnknownAtoms( verbose=verbosity )
...
#
# added zinc coordination chirality restraints
# 2012.05.09 ECI
#

from xplorPot import XplorPot
protocol.initDihedrals( ["restraints/dihedrals.tbl","restraints/zn_chirality.tbl"] )                      
